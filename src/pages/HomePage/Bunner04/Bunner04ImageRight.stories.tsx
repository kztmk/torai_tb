...
import { Bunner04ImageRight } from './Bunner04ImageRight'; // コンポーネントをインポート

// Storybook の設定: https://storybook.js.org/docs/react/writing-stories/introduction#default-export
const meta: Meta<typeof Bunner04ImageRight> = {
  title: 'Pages/HomePage/Bunner04ImageRight', // Storybook UI での表示名
  component: Bunner04ImageRight,
  parameters: {
