...
import { Bunner01ImageLeft } from './Bunner01ImageLeft'; // コンポーネントをインポート

// Storybook の設定: https://storybook.js.org/docs/react/writing-stories/introduction#default-export
const meta: Meta<typeof Bunner01ImageLeft> = {
  title: 'Pages/HomePage/Bunner03ImageLeft', // Storybook UI での表示名
  component: Bunner01ImageLeft,
  parameters: {
